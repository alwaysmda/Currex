...
//        };
//
//        Intent serviceIntent = appClass.getMarket().getIntentBilling();
//        serviceIntent.setPackage(appClass.getMarket().getPackageName());
...
//            logDebug("StoredData signature: " + dataSignature);
