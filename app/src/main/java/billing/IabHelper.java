...
import billing.communication.BillingSupportCommunication;
import billing.communication.OnConnectListener;
...
public class IabHelper {
    ...
    public IabHelper(String base64PublicKey, ApplicationClass appClass) {
    ...
    public void startSetup(final OnIabSetupFinishedListener listener) {
        NativeBillingV4Helper.Companion.setErrorTrace(NativeBillingV4Helper.Companion.getErrorTrace() + ",2");
        // If already set up, can't do it again.
        checkNotDisposed();
        NativeBillingV4Helper.Companion.setErrorTrace(NativeBillingV4Helper.Companion.getErrorTrace() + ",5");
        if (iabConnection != null) throw new IllegalStateException("IAB helper is already set up.");

        NativeBillingV4Helper.Companion.setErrorTrace(NativeBillingV4Helper.Companion.getErrorTrace() + ",6");
        ...
        NativeBillingV4Helper.Companion.setErrorTrace(NativeBillingV4Helper.Companion.getErrorTrace() + ",7");
        IAB serviceIAB = new ServiceIAB(logger);
        NativeBillingV4Helper.Companion.setErrorTrace(NativeBillingV4Helper.Companion.getErrorTrace() + ",8");
        boolean canConnectToService = serviceIAB.connect(mContext, connectListener);
        NativeBillingV4Helper.Companion.setErrorTrace(NativeBillingV4Helper.Companion.getErrorTrace() + ",20");
        if (canConnectToService) {
            NativeBillingV4Helper.Companion.setErrorTrace(NativeBillingV4Helper.Companion.getErrorTrace() + ",21");
            iabConnection = serviceIAB;
        } else {
            NativeBillingV4Helper.Companion.setErrorTrace(NativeBillingV4Helper.Companion.getErrorTrace() + ",22");
            ...
            NativeBillingV4Helper.Companion.setErrorTrace(NativeBillingV4Helper.Companion.getErrorTrace() + ",23");
            if (canConnectToReceiver) {
                NativeBillingV4Helper.Companion.setErrorTrace(NativeBillingV4Helper.Companion.getErrorTrace() + ",24");
                iabConnection = broadcastIAB;
            }
        }

        if (iabConnection == null && listener != null) {
            NativeBillingV4Helper.Companion.setErrorTrace(NativeBillingV4Helper.Companion.getErrorTrace() + ",25");
            ...
            NativeBillingV4Helper.Companion.setErrorTrace(NativeBillingV4Helper.Companion.getErrorTrace() + ",26");
        }
    }

    private void checkBillingSupported(final OnIabSetupFinishedListener listener) {
        NativeBillingV4Helper.Companion.setErrorTrace(NativeBillingV4Helper.Companion.getErrorTrace() + ",27");
        String packageName = mContext.getPackageName();
        NativeBillingV4Helper.Companion.setErrorTrace(NativeBillingV4Helper.Companion.getErrorTrace() + ",28");
        iabConnection.isBillingSupported(3, packageName, new BillingSupportCommunication() {
            ...
            public void onBillingSupportResult(int response) {
                NativeBillingV4Helper.Companion.setErrorTrace(NativeBillingV4Helper.Companion.getErrorTrace() + ",29");
                if (listener == null) {
                    NativeBillingV4Helper.Companion.setErrorTrace(NativeBillingV4Helper.Companion.getErrorTrace() + ",30");
                    return;
                }

                if (response != BILLING_RESPONSE_RESULT_OK) {
                    NativeBillingV4Helper.Companion.setErrorTrace(NativeBillingV4Helper.Companion.getErrorTrace() + ",31");
                    listener.onIabSetupFinished(new IabResult(response,
                                                              "Error checking for billing v3 support."));
                } else {
                    NativeBillingV4Helper.Companion.setErrorTrace(NativeBillingV4Helper.Companion.getErrorTrace() + ",32");
            ...
            public void remoteExceptionHappened(IabResult result) {
                NativeBillingV4Helper.Companion.setErrorTrace(NativeBillingV4Helper.Companion.getErrorTrace() + ",33" + result.mMessage);
    ...
    private void checkNotDisposed() {
        NativeBillingV4Helper.Companion.setErrorTrace(NativeBillingV4Helper.Companion.getErrorTrace() + ",3");
        if (mDisposed) {
            NativeBillingV4Helper.Companion.setErrorTrace(NativeBillingV4Helper.Companion.getErrorTrace() + ",4");
